...
// Componente responsável por exibir os filtros no rodapé da página
  ...
  return (
    ...
    <footer style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        <span style={{ fontSize: '0.7em', color: '#aaa', fontWeight: 'bold' }}>
          VESTIBULAR
        </span>

        {/* Select que altera o vestibular selecionado */}
        <select
          name="vestibular"
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        ...
        {/* Lista de anos gerada automaticamente com map */}
        <select
          name="ano"
          value={filtros.ano}
          onChange={onChangeFiltro}
        ...
        >
          ...
          {/* Percorre o array de anos e cria uma opção para cada um */}
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        ...
        {/* Select responsável pelo tópico escolhido */}
        <select
          name="topico"
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        ...
        {/* Select que define a dificuldade das questões */}
        <select
          name="dificuldade"
      ...
      {/* Botão que chama a função responsável por aplicar os filtros */}
      <button
